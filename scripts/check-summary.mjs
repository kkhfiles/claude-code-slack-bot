...
// **제목은 단계가 넘어갔을 때만 온다.** 왔으면 그대로 실어 보낸다 — 바꿀지
// 말지의 판단은 프롬프트가 하고, 덮을지 말지는 파이썬이 한다.
eq('제목이 오면 같이 싣는다',
  P('{"TSK-5":{"summary":"요약","title":"세미나 결과 정리"}}'),
  { 'TSK-5': { summary: '요약', title: '세미나 결과 정리' } });
eq('빈 제목은 안 싣는다',
  P('{"TSK-5":{"summary":"요약","title":"   "}}'),
  { 'TSK-5': { summary: '요약' } });
eq('제목이 글자가 아니면 안 싣는다',
  P('{"TSK-5":{"summary":"요약","title":123}}'),
  { 'TSK-5': { summary: '요약' } });
