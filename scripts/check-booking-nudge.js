...
function ask(hoursAgo, user = 'U1', name = '홍길동') {
...
(async () => {
  ...
  check('누가 며칠째 기다리는지 적는다',
    r.sent[0] && /홍길동/.test(r.sent[0].text) && /1일째/.test(r.sent[0].text),
