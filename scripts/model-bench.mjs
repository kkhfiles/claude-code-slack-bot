...
const CASES = [
  ...
  { id: 'A1', kind: 'A', want: 'TSK-61 · 소프트 마감 09/08(화) · **하드 마감을 새로 만들지 않음** · 진행 로그',
    text: '[진행판] TSK-61 「PAS 8800 백서 작성 진행 확인 (작성: 홍길동 책임)」\n초안은 다음주 화요일까지 받기로 했습니다.' },
  ...
  { id: 'A3', kind: 'A', want: 'TSK-50 · 소프트 마감과 내 차례를 **둘 다** 09/11(금) · 진행 로그',
    text: '[진행판] TSK-50 「SOSC 하반기 운영 변경 — 이영희 전임이 RT 담당 박민수과 사전 점검」\n이영희 전임이 다음주 금요일 주간회의에서 결과 공유하기로 했습니다. 그때까지 제가 할 건 없습니다.' },
