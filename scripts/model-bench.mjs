 ...
 */
const CASES = [
  { id: 'A1', kind: 'A', want: 'TSK-14 · 마감 09/04(금) · 진행 로그',
    text: '[진행판] TSK-14 「전현빈 선임과 DVERA 레벨 하네스 구축 계획 싱크」\n이건 이번주 금요일까지이다. 오늘 오후에 한번더 싱크 예정.' },
  { id: 'A2', kind: 'A', want: 'TSK-54 · 진행 로그만 (날짜 안 건드림)',
    text: '[진행판] TSK-54 「GPT·Claude 프리미엄 시트 수요 조사」\n부서원 대상 설문 초안 만들었습니다. 15명 정도 응답 예상.' },
  { id: 'A3', kind: 'A', want: 'TSK-25 · 마감 오늘(09/01) · 다음 행동 · 뒤로 미루므로 연기 사유',
    text: '[진행판] TSK-25 「[B2A] 레지스트리·마켓플레이스 목록 조사·준비 (DVERA, ALIRA)」\n오늘 오후2시 회의 전까지 준비' },
  { id: 'B1', kind: 'B', want: 'TSK-61(PAS 8800 백서) 를 스스로 찾아 진행 로그',
    text: '백서 초안 방향 홍길동 책임한테 전달했습니다. 다음주에 중간 리뷰 볼 예정.' },
  { id: 'B2', kind: 'B', want: 'TSK-56(주간업무 커피콩 설명) 를 찾아 상태 진행중 또는 로그',
    text: '커피콩 설명 자료 오늘 시작했어요.' },
